...
function emailOpsResult() {
  ...
  return {
    ...
    output: {
      ...
      needsApproval: 0,
      calendarDrafts: 0,
      providerStatuses: [{ provider: "gmail", ok: true, status: "CONNECTED", detail: "2/3 ingested", lastSyncAt: now.toISOString() }],
      backfill: { enabled: true, lookbackDays: 90, processed: 3 },
      specialistRuns: [],
      approvals: [],
      risks: [],
      evidence: [],
