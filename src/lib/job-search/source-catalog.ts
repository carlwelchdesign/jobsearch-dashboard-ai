...
export const sourceCatalog: SourceCatalogItem[] = [
  ...
  source("Recruitee", "ats_platform", 2, "active", "search_query", ["Europe", "Global"], seniorEngineeringRoles, true, false, "medium", "daily", "Covered through Brave Search query templates, but Recruitee-hosted job URLs must redirect to a company-owned career domain before they become launchable."),
