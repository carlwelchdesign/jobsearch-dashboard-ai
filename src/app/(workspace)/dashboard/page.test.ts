...
const workspaceApp = "src/app/(workspace)";

describe("Daily cockpit dashboard routes", () => {
  it("keeps focused operations routes but removes the subnav from Today", () => {
    const contentSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/dashboard-content.tsx"), "utf8");
    const overviewSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/page.tsx"), "utf8");
    const searchSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/search/page.tsx"), "utf8");
    const emailOpsSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/email-ops/page.tsx"), "utf8");
    const socialSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/social/page.tsx"), "utf8");
    const marketSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/market/page.tsx"), "utf8");
    const pipelineSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/pipeline/page.tsx"), "utf8");
  ...
  it("keeps market analysis centralized on the market dashboard route", () => {
    const contentSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/dashboard-content.tsx"), "utf8");
    const tabsSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/market-analysis-tabs.tsx"), "utf8");
    const chartsSource = readFileSync(resolve(process.cwd(), workspaceApp, "dashboard/market-analysis-charts.tsx"), "utf8");
    const profilesSource = readFileSync(resolve(process.cwd(), workspaceApp, "profiles/page.tsx"), "utf8");
